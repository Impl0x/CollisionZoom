...
namespace CollisionZoom
{
    ...
    public struct Rectangle
    {
        ...
        public Rectangle(double width, double height)
            : this(Vector.Zero, new Vector(width, height))
        { }
    ...
    public struct Transform
    {
        ...
        {
            Point tl = this.Project(Source.TopLeft);
            Point tr = this.Project(Source.TopRight);
            Point bl = this.Project(Source.BottomLeft);
            Point br = this.Project(Source.BottomRight);
